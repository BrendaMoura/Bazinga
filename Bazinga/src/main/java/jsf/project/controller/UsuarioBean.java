...
public class UsuarioBean implements Serializable{
	...
	public String entrar() {
		...
		if(resultado == 0) {
			...
			context.addMessage(null, new FacesMessage("Successful",  "Usuario nao cadastrado!") );
		}
		else if(resultado==1) {
			...
			context.addMessage(null, new FacesMessage("Successful",  "Email e/ou senha incorretos") );
		}
